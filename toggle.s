 ...
 * 					unsigned int part1 );
 * Description: Toggles all the bits in pattern specified in part0 and part1. 
...
@ Standard prologue
	...
	sub	sp, sp, PARAM_SPACE 		@ allocate space for the param-
						@ eters
	str	r0, [fp, PATTERN_OFFSET]	@ store pattern[0] in memory
...
@ Second operation on pattern[1]
	...
	ldr	r3, [r0]			@ get the value of pattern[1]
